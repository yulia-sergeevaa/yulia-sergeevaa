...
Как это часто бывает, в компании, где я работала, не хватало ресурсов аналитиков. Поэтому я стала изучать SQL для самостоятельного выполнения несложных задач, что переросло в увлечение, полноценное обучение аналитике данных и желание сменить вектор карьерного развития.  

Маркетинговая экспертиза и опыт зачастую позволяют мне как аналитику легко понимать структуру данных, их значимость и применимость, а также строить и проверять ценные гипотезы.   

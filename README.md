...
Как это часто бывает, в компании, где я работала, не хватало ресурсов аналитиков, поэтому я стала изучать SQL для самостоятельного выполнения несложных задач, что переросло в полноценное обучение аналитике данных и желание сменить вектор карьерного развития.  

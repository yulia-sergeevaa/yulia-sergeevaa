...
Как это часто бывает, в компании, где я работала, не хватало ресурсов аналитиков, и тогда я стала изучать SQL для самостоятельного выполнения несложных задач, что переросло в полноценное обучение аналитике данных и желание сменить вектор карьерного развития.  

Маркетинговая экспертиза и опыт зачастую позволяют мне легко понимать структуру данных, их значимость и применимость, а также строить и проверять ценные гипотезы.   
